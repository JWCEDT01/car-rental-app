...
export default async function CarDetailPage({
  ...
  return (
    <main className="text-center p-5">
      <h1 className="text-lg font-meduim">{carDetail.data.model}</h1>
      <div className="flex flex-row my-5">
        ...
        <div className="text-md mx-5 text-left">
          ...
          >
            <button className="block rounded-md bg-sky-600 hover:bg-indigo-600 text-white px-3 py-2 shadow-sm">
              Make Reservation
            </button>
          </Link>
        </div>
...
//! This function cannot use in Vercel
// Pre-render all car detail pages at build time
